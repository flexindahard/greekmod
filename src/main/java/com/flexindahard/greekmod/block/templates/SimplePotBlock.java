...
public class SimplePotBlock extends GenericModBlock {
    ...
    public static final VoxelShape KILIK_NORTH = Block.box(1, 0, 3, 15, 6.5, 13);
    public static final VoxelShape KILIK_EAST = Block.box(3, 0, 1, 13, 6.5, 15);
    ...
    public static final VoxelShape AMFORA_NORTH = Block.box(3.5, 0, 4, 12.5, 24, 12);
    public static final VoxelShape AMFORA_EAST = Block.box(4, 0, 3.5, 12, 24, 12.5);
